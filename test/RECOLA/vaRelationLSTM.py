...
# load data
series = DataFrame({'Valence': v, 'Arousal': a})
# parameter setup
n_lag = 1       # use n_lag data
n_seq = 3       # forecast n_seq data
n_test = 10     # test data is in n_test groups
n_epochs = 1    # train n_epochs times
n_batch = 2     # train n_batch data a time
